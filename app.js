...
//My axis orientation: invers image when y along is neg or when both x+y are positive
    ...
    var axisInput = document.getElementByID("inputAxis");
    ...
    var ax = 0;
        ...
        /* Update input axis */
axisInput.addEventListener("input", function(e) {
    ax = axisInput.value;
}, false);
        ...
        window.addEventListener("devicemotion", function(event) {
          ...
          axis.style.transform = 
              "rotate(" + ( ax + 180-calcAngle(event.accelerationIncludingGravity.x,event.accelerationIncludingGravity.y) ) + "deg) ";
        });
